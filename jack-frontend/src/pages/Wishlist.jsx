...
const Wishlist = ({ isLoggedIn, setIsLoggedIn }) => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "My Wishlist | Jack Essentials — Saved Items";
  }, []);
  ...
  }, [user, isLoadingSession, fetchWishlist]);
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] font-sans text-slate-900 selection:bg-[#FF4500] selection:text-white pb-20">
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 md:mt-12">
        ...
        {!user ? (
          <div className="bg-white rounded-[2rem] p-10 md:p-16 text-center border border-slate-100 shadow-sm max-w-xl mx-auto">
            ...
            <Link to="/login" className="bg-slate-900 text-white px-8 py-3.5 rounded-xl font-bold hover:bg-[#FF4500] transition-colors shadow-md inline-block outline-none focus-visible:ring-4 focus-visible:ring-slate-300">
              Login to Continue
            </Link>
          </div>
          ...
          <div className="bg-white rounded-[2rem] p-10 md:p-16 text-center border border-slate-100 shadow-sm max-w-xl mx-auto">
            ...
            <Link to="/shop" className="bg-[#FF4500] text-white px-8 py-3.5 rounded-xl font-bold hover:bg-orange-600 transition-colors shadow-lg shadow-orange-500/20 inline-flex items-center gap-2 outline-none focus-visible:ring-4 focus-visible:ring-orange-500/30">
                ...
                return (
                  ...
                  >
                    ...
                    <button 
                      ...
                      className="absolute top-4 right-4 z-10 p-2 bg-white/90 backdrop-blur-sm rounded-full text-slate-400 hover:text-red-500 hover:bg-red-50 transition-colors shadow-sm outline-none"
                    ...
                    <div className="flex flex-col flex-1">
                      ...
                      <Link to={`/product/${product.id || product._id}`} className="outline-none focus-visible:text-[#FF4500]">
                      ...
                      <div className="mt-auto flex flex-col gap-3">
                        ...
                        <button 
                          ...
                          className="w-full bg-slate-100 hover:bg-slate-900 text-slate-900 hover:text-white font-bold py-2.5 rounded-xl flex items-center justify-center gap-2 transition-colors text-xs uppercase tracking-wide outline-none focus-visible:ring-2 focus-visible:ring-slate-900"
                        >
